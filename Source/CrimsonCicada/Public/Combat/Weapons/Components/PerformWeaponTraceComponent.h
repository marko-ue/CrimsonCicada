...
public:
	...
	bool PerformSpreadTraces(FVector TraceStart, FVector ForwardDirection, float SpreadAngleDegrees,
	int32 NumTraces, float TraceRange,TArray<FHitResult>& OutHits, ECollisionChannel TraceChannel);
};
